...
- In modern video lectures, such as Bala Subramaniam's VBT series (Sutra 3: "Is the creation separate from Bhairava?"), the question of the ninefold divisions and forms is explained as an inquiry into whether the physical or conceptual universe is distinct from the source. The lecture emphasizes that the infinite variety of forms, states, and scriptural subdivisions are not separate from the singular consciousness of Bhairava, but are its own self-projection [subramaniam2026vbt].
